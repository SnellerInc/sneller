...
const (
	...
	opMatchpatCs              bcop = 321
	opMatchpatCi              bcop = 322
	opMatchpatUTF8Ci          bcop = 323
	opIsSubnetOfIP4           bcop = 324
	opDfaT6                   bcop = 325
	opDfaT7                   bcop = 326
	opDfaT8                   bcop = 327
	opDfaT6Z                  bcop = 328
	...
	opslower                  bcop = 332
	opsupper                  bcop = 333
	opsadjustsize             bcop = 334
	opaggapproxcount          bcop = 335
	opaggapproxcountmerge     bcop = 336
	opaggslotapproxcount      bcop = 337
	opaggslotapproxcountmerge bcop = 338
	optrap                    bcop = 339
	_maxbcop                       = 340
)
