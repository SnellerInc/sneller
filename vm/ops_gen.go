...
const (
	...
	opTrimPrefixCs           bcop = 291
	opTrimPrefixCi           bcop = 292
	opTrimSuffixCs           bcop = 293
	opTrimSuffixCi           bcop = 294
	opContainsSubstrCs       bcop = 295
	opContainsSubstrCi       bcop = 296
	opContainsSuffixCs       bcop = 297
	opContainsSuffixCi       bcop = 298
	opContainsSuffixUTF8Ci   bcop = 299
	opContainsPrefixCs       bcop = 300
	opContainsPrefixCi       bcop = 301
	opContainsPrefixUTF8Ci   bcop = 302
	opLengthStr              bcop = 303
	opSubstr                 bcop = 304
	opSplitPart              bcop = 305
	opMatchpatCs             bcop = 306
	opMatchpatCi             bcop = 307
	opMatchpatUTF8Ci         bcop = 308
