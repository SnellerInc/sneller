...
func main() {
	...
	flag.StringVar(&outpath, "o", "", "bytecode file path")
	...
	err = writeDefinitions(opcodes, argtype, buf)
	check(err)
...
func writeDefinitions(opcodes []Opcode, argtype string, f io.Writer) error {
