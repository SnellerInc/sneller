...
#define CONSTF64_POSITIVE_INF() CONST_GET_PTR(constpool, CONSTPOOL_F64_INDEX + 48)
CONST_DATA_U64(constpool, CONSTPOOL_F64_INDEX + 48, $0x7FF0000000000000)

#define CONSTF64_NEGATIVE_INF() CONST_GET_PTR(constpool, CONSTPOOL_F64_INDEX + 56)
CONST_DATA_U64(constpool, CONSTPOOL_F64_INDEX + 56, $0xFFF0000000000000)
