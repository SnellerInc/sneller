	...
	tcs := []struct {
		...
		},
		{
			...
			text: []string{
				...
				"cmplt.imm.f f64(1)",
				"or.k [2]",
				"findsym2 [0], u32(0xB)", // <-- notice we use mask from above!
				"save.k [0]",
				"toint",
				"save.k [2]",
				"cmplt.imm.i i64(2)",
		...
		},
		{
			...
			text: []string{
				// FIXME: the instruction scheduling here
				// is pretty sub-optimal. We should probably
				// use a different ordering heuristic.
				"save.k [0]",
				"findsym u32(0xA)", // search for foo
				"save.v [8]",
				"save.k [2]",
				"findsym2rev [0], u32(0xB)", // search for bar
				"save.k [0]",
				"toint",
				"save.k [4]",
				"cmplt.imm.i i64(2)",
				...
				"tof64",
				"cmplt.imm.f f64(2)",
				"or.k [4]",   // end conditional for bar
				"load.v [8]", // load mask and value for foo
				"save.k [4]",
				"load.k [2]",
				"toint",
				"save.k [0]",
		...
		},
		{
			...
			text: []string{
				...
				"cvti64tof64",
				"or.k [2]",
				"cmpgt.f [8]", // notice < was converted to >
				"ret",
			},
		},
	}
